...
\cfoot{\footnotesize April, 2024}                                    % Footer: center side empty
...
\vspace{5pt}
{\color{headings} \scshape{April, 2024}}\\
\vspace{10pt}}
...
\begin{itemize}
  ...
  \item \textbf{Researcher}, Instituto Flores de Lemus, Department of Statistics, Universidad Carlos III de Madrid, Spain, 2008/09--2014/03.
  \item \textbf{Assistant Researcher}, Instituto Flores de Lemus, Department of Statistics, Universidad Carlos III de Madrid, Spain, 2002/01--2008/08.
...
\begin{itemize}
\item \textbf{``Shocks and elasticities in the global oil market''} 
\item \textbf{``The pass-through of commodity price volatility to inflation''} (with Rebeca Jiménez-Rodríguez)
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Microeconomía (UG), 2019--2020.
  \end{itemize}
  \item Universidad Nacional de Colombia:
  Macroeconomía (UG, PG) , 1997--1999.
\end{itemize}
