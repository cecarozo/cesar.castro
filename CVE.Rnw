...
\vspace{5pt}
{\color{headings} \scshape{October, 2016}}\\
\vspace{10pt}}

\colorbox{shade}{{
\begin{tabular}{c|p{13cm}}
\vspace{5pt}\raisebox{-4pt}{\textifsymbol{18}} & Calle Cipriano Sancho, 36, 4-A, Madrid, 28017 \\
\vspace{5pt}\raisebox{-4pt}{\Mobilefone} & (+34) 679 54 82 37\\
\vspace{5pt}\raisebox{-4pt}{\Letter} & \href{mailto:castrorozo@gmail.com}{ccastrorozo@gmail.com} \\
\vspace{5pt}\raisebox{-4pt}{\Aquarius} & Nationality: Colombia - Spain\\
\vspace{5pt}\raisebox{-4pt}{\Mundus} & \href{https://cecarozo.github.io/cesar.castro}{https://cecarozo.github.io/cesar.castro/index.html}\\
\end{tabular}
}
}\\[10pt]
...
\vspace{5pt}& Dissertation: Three Essays on Applied Time Series Econometrics.\\
...
\begin{enumerate}
\item \textbf{``A new look at oil price pass-through into inflation: Evidence from disaggregated European data.''} Joint with R. Jiménez-Rodríguez (U. Salamanca), P. Poncela (European Commission), and E. Senra (U. Alcalá). \emph{Economia Politica: Journal of Analytical and Institutional Economics}, (2016), Forthcoming.
