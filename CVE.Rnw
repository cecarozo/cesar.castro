...
\item \textbf{``The impact of oil shocks on the stock market''} with Jiménez-Rodríguez, R. (Universidad de Salamanca). Global Finance Journal, 60, 100967, 2024.

\item \textbf{``Time-Varying Relation between Oil Shocks and European Stock Market Returns''} with Jiménez-Rodríguez, R. (Universidad de Salamanca), & Kizys, R. (University of Southampton). Journal of Risk and Financial Management, 16(3), 174, 2023.
