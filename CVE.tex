...
\cfoot{\sffamily\footnotesize November, 2019}                                    % Footer: center side empty
...
\vspace{5pt}
{\color{headings} \scshape{November, 2019}}\\
\vspace{10pt}
}
...
2018 -- & Assistant Professor, Department of Economics, Universidad Pública de Navarra, Spain\\
...
\section{Work in progress or submitted}
 ...
 \textbf{``Time-varying relationship between oil shocks and European stock market returns''} with R. Jiménez-Rodríguez (Universidad de Salamanca) and Renatas Kizys (University of Portsmouth).

 \textbf{``A new approach to modelling interactions between oil price and exchange rate''} with R. Jiménez-Rodríguez (Universidad de Salamanca). Previously circulated under the title \underline{``Time-varying relationship between oil price changes and exchange rates''}.

 \textbf{``Oil price shocks and inflation across euro area countries''} with A. Barge-Gil (Universidad Complutense de Madrid), and M. Jerez (Universidad Complutense de Madrid).

 \textbf{``Oil price pass-through into inflation in Spain at national and regional level''} with A. Barge-Gil (Universidad Complutense de Madrid), and M. Jerez (Universidad Complutense de Madrid).
...
\section{Research Projects} 
 ...
 \textbf{Dynamic econometric models, forecasts, economic outlook, inflation, macroeconomic models and time series.} Project leader: Antoni Espasa. Research funding: Universidad Carlos III de Madrid. Spain, 2010--2014.

 \textbf{Forecast and macroeconomic analysis. Inflation and relative prices in the region of Andalucia, Spain.} Project leader: Antoni Espasa. Research funding: Government of Andalucia. Spain, 2007--2009.

 \textbf{Analysis and forecasts of inflation.} Project leader: Antoni Espasa. Research funding: Universidad Carlos III de Madrid. Spain, 2006--2007.
