...
\cfoot{\sffamily\footnotesize November, 2018}                                    % Footer: center side empty
...
\vspace{5pt}
{\color{headings} \scshape{November, 2018}}\\
\vspace{10pt}
}
...
& Campus Arrosadia, Los Madroños Building\\
...
\item \textbf{``Time-varying relationship between oil price changes and exchange rates.''} Universidad de Malaga, Spain, 2018.

\item \textbf{``Time-varying relationship between oil price changes and exchange rates.''} Universidad Autónoma de Madrid, Spain, 2017.
