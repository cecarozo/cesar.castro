...
\cfoot{\footnotesize November 2022}                                    % Footer: center side empty
...
\vspace{5pt}
{\color{headings} \scshape{November 2022}}\\
\vspace{10pt}}

\colorbox{shade}{{
\begin{tabular}{c|p{8cm}}

{\textifsymbol{18}} & \href{https://www.unavarra.es/departament-economia}{Department of Economics}\\
...
\item\textbf{Assistant Professor}, Department of Economics, Universidad Pública de Navarra (UPNA), Spain, November 2018--present.\\
\end{itemize}
