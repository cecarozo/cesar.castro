...
\cfoot{\sffamily\footnotesize December, 2019}                                    % Footer: center side empty
...
\vspace{5pt}
{\color{headings} \scshape{December, 2019}}\\
\vspace{10pt}
}
...
Assistant Professor, Department of Economics, Universidad Pública de Navarra, Spain\\
...
\begin{tabular}{R{0.1cm} L{14cm}}
 ...
 · & \textbf{``Oil price pass-through along the price chain in the euro area''} with R. Jiménez-Rodríguez (Universidad de Salamanca). \emph{Energy Economics}, (2017), \textbf{64}, 24--30.\\[.2cm]
...
· & \textbf{``The deflationary effect of oil prices in the euro area''} with A. Barge-Gil (Universidad Complutense de Madrid), and M. Jerez (Universidad Complutense de Madrid). \emph{Energy Economics}, (2016), \textbf{56}, 389--397.\\[.2cm]

· & \textbf{``Oil Prices and Inflation in the Euro Area and its Main Countries: Germany, France, Italy and Spain''} with P. Poncela (Universidad Autónoma de Madrid) and E. Senra (Universidad de Alcalá). \emph{FUNCAS Working papers series}, (2012), \textbf{701}.\\[.2cm]

· & \textbf{``Do we see the effects of oil variations in official statistics price data?''} with P. Poncela (Universidad Autónoma de Madrid), and E. Senra (Universidad de Alcalá). \emph{Boletín de Estadística e Investigación Operativa}, (2011), \textbf{27}, 29--41.\\[.2cm]

· & \textbf{``El diferencial de inflación en los servicios entre España y la euro área''} with E. Carluccio (Universidad Carlos III de Madrid). \emph{Papeles de Economía Española}, (2009), \textbf{120}, 69--89.\\[.2cm]

· & \textbf{``Mercado de crédito 1990-1999. La factura de cobro del financiamiento''} with J. Espitia (General Controller of Colombia), and J. Villamizar (General Controller of Colombia). \emph{Gestión Fiscal}, (2000), \textbf{8}, 6--33.\\[.2cm]

· & \textbf{``La demanda de lotería y juegos de azar''} with J.I. González (Universidad Nacional de Colombia). \emph{INNOVAR, Revista de Ciencias Administrativas y Sociales}, (2000), \textbf{16}, 27--48.}\\
...
· & Universidad de Salamanca, Outstanding Doctorate Award\\
· & Santander Bank - Universidad de Alcalá, Scholarship\\
· & Inter-American Development Bank, Invited to the Youth and Growth Forum, Jerusalem, Israel.\\
