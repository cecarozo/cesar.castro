...
date: "Updated: July 31, 2018" # !!!! cambiar sombras (sumar 1 observación)
...
dygraph(data, width = 900, height = 450) %>% 
  dyHighlight(highlightCircleSize = 5,
              ...
              hideOnMouseOut = FALSE) %>%
  dyRangeSelector() %>%
  dyShading(from = "2018-7-1", to = "2019-12-1", color = '#F7E7CE')
```

****
### Innovations by sectors in the inflation of June, 2018
```{r, warning=FALSE, echo=FALSE, message=FALSE, results='asis'}
