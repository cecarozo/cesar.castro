...
****
### Innovations by sectors in the second quarter-2017
...
colnames(s.annual.table) <- c('--2014--', '--2015--', '--2016--', '--2017--',
                              '--2018--')

s.annual.table <- xtable(s.annual.table, caption='year-on-year rates. 2017 and 2018 are forecasts',
...
colnames(d.annual.table) <- c('--2014--', '--2015--', '--2016--',
                              '--2017--', '--2018--')

d.annual.table <- xtable(d.annual.table, 
                         caption='year-on-year rates. 2017 and 2018 are forecasts',
...
****
### Innovations by sectors in the inflation of July-2017
...
rownames(p.table) <- c('2014--', '2015--', '2016--', '2017--', '2018--')
...
p.table <- xtable(p.table, caption='Year-on-year rates. 2017 and 2018 are forecasts', label='i.table', align=c('r|cc|cccc'), digits=1)
