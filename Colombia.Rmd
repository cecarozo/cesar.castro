...
dygraph(data, width = 900, height = 450) %>% 
  dyRangeSelector() %>%
  dyShading(from = "2018-1-1", to = "2019-12-1", color = '#F7E7CE')
...
data.fan <- t(data.fan)
data.fan <- ts(data.fan, start = c(2018, 2), frequency = 4)
...
dygraph(prueba, width = 900, height = 450) %>%
  ...
  dySeries(c('L60', 'point', 'U60'), label = '60%') %>%
  dySeries(c('L40', 'point', 'U40'), label = '40%') %>%
  dySeries(c('L20', 'point', 'U20'), label = '20%') %>%
  dyAxis("y", valueRange = c(-1, 10)) %>%
...
datatable(data,
          ...
          formatStyle(c('18-2', '18-3', '18-4', '19-1'), backgroundColor = '#F7E7CE')
```
...
dygraph(data, width = 900, height = 450) %>% 
  dyHighlight(highlightCircleSize = 5,
              ...
              hideOnMouseOut = FALSE) %>%
  dyRangeSelector() %>%
  dyShading(from = "2018-5-1", to = "2019-12-1", color = '#F7E7CE')
```
