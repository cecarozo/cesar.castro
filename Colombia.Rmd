...
****
### Innovations by sectors in February-2017
...
****
## MONETARY POLICY (SYSTEMATIC MONETARY POLICY)

The taylor rule shows that in the next months, the Central Bank could decreased the key interest rate, from the current 7.75 to 6.5 in the next 6 months. 
...
plot(g, type='s', ylim=c(2, 9), yaxt='n', xaxt='n', ylab='', xlab='',
     lwd = 2, lty=1, bty='n', main='Key interest rate, Central Bank')  
rect(time(inflactual)[(200-113):(200-113)],
     1.5,
     time(inflactual)[108:108],
