...
\item \textbf{``Time-varying relationship between oil price changes and exchange rates.''} Departamento de Economía, Universidad de Malaga, Spain, 2018.

\item \textbf{``Time-varying relationship between oil price changes and exchange rates.''} Departamento de Economía, Universidad Autónoma de Madrid, Spain, 2017.
